;(function ($, document, window) {
    ...
    Plugin.prototype.init = function () {
        ...
        $this.btn = $(
            ['<div className="container"><' + settings.parentTag + ' aria-haspopup="true" role="button" tabindex="0" className="' + prefix + '_btn ' + prefix + '_collapsed">',
                '<span className="' + prefix + '_menutxt">' + settings.label + '</span>',
                '<span className="' + iconClass + '">',
                    '<span className="menu-icon"><span className="menu-icon-inner"></span></span>',
